...
enum L {
    ...
    static let kcalSurplusFormat = "kcal_surplus_format"
    static let kcalMaintainFormat = "kcal_maintain_format"
    static let kcalOnTarget = "kcal_on_target"
    static let surplusShort = "surplus_short"
    static let balanceShort = "balance_short"
    static let realSurplus = "real_surplus"
    static let realBalance = "real_balance"
    static let surplusApproxFormat = "surplus_approx_format"
    static let surplusValueFormat = "surplus_value_format"
    static let maintainApproxFormat = "maintain_approx_format"
    static let maintainValueFormat = "maintain_value_format"
    static let noSurplusDeficitFormat = "no_surplus_deficit_format"
    static let surplusBehindByFormat = "surplus_behind_by"
    static let surplusGoalReachedFormat = "surplus_goal_reached"
    static let balanceOffFormat = "balance_off_format"
    static let balanceOnTarget = "balance_on_target"
    ...
    static let bestSurplusDay = "best_surplus_day"
    static let bestBalanceDay = "best_balance_day"
